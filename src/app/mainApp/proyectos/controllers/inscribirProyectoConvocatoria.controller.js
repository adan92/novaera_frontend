...
(function () {
  ...
  /* @ngInject */
  function inscribirProyectoConvocatoriaController($window, Catalogo, $mdDialog, $mdMedia, toastr, TRL, Convocatoria, Operation,
    ...
    function onResize() {
      vm.listStyle.height = ($window.innerHeight -200) + 'px';
