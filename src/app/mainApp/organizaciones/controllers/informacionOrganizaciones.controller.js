...
(function() {
    ...
    function informacionOrganizacionesController($scope ,Upload,$timeout, $mdToast, $rootScope, $state,$log) {
        ...
        $scope.$watchGroup(['vm.selectedItem'], function(newValues, oldValues, scope) {
            ...
            {
                vm.newOrganization = {palabras_clave:[]};
            ...
            return [
                {
                    ...
                    palabras_clave: [{id:1,nombre:"Ingeniería"},{id:2,nombre:"Comercio"}],
        ...
        {
            var results = query ? vm.contacts.filter( createFilterForContact(query) ) : vm.contacts, deferred;
            return results
        }
