(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController(User, $scope, $mdMedia, $translate, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, triBreadcrumbsService, triSettings, triLayout) {
        var vm = this;
